Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"21 69 106 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"0 0 0 220" // Shadow color
		"G_LightShadow"			"0 0 0 110"
		"G_Heal"				"143 185 59 255" // Heal color
		"G_Hit"					"83 164 196 255" // Hit color
		...
		"G_LightGrey"			"175 175 175 255" // Metal color in build/destroy menu
		"G_HealthBarBg"			"0 0 0 220" // Target health bg
		"G_CurrencyBad"			"255 60 60 255" // Red currency in MvM
		"G_TransparentMenuBG"	"38 38 38 242" // Transparent menu color
		"G_PanelBg"				"38 38 38 242" // Panel color
		"G_OpaquePanelBg"		"38 38 38 255" // Opaque Panel color
		"G_Warning"				"21 69 106 255" // Warning color
		"G_HealthValue"			"87 193 245 255" // Health value color
		"G_Overheal"			"164 208 7 255" // Overhealed health value color
		"G_LowHealthValue"		"167 255 255 255" // Low health value color
		"G_AmmoClipValue"		"87 193 245 255" // Ammo in clip value color
		"G_AmmoReserveValue"	"164 208 7 255" // Ammo in reserve value color
		"G_LowAmmo"				"42 91 115 255" // Low ammo color
		"G_MetalValue"			"175 175 175 255" // Metal color
		"G_MetalIcon"			"175 175 175 255" // Metal icon color
		"G_HeadsValue"			"175 175 175 255" // Heads value color
		"G_HeadsLabel"			"175 175 175 255" // Heads value icon color
		"G_KillstreakValue"		"175 175 175 255" // Killstreak value color
		"G_KillstreakIcon"		"175 175 175 255" // Killstreak icon color
		"G_StickyColor"					"175 175 175 255" // Stickybomb color
		"G_StickyIconColor"				"175 175 175 255" // Stickybomb icon color
		"G_CustomTargetID" 				"0 0 0 191" // Custom target id bg color
		"G_CustomBuildingStatusBg" 		"0 0 0 100" // Custom building status bg color
		"G_TargetHealthValue" 			"120 120 120 255" // Target ID health value color
		...
		"G_Footer"					"38 38 38 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"175 175 175 255" // Footer text color
		"G_DimmFooterText"			"175 175 175 120" // Dimm Footer text color
		...
		"G_MainMenuOverlay"			"32 61 90 209" // Main Menu overlay color
		"G_MainMenuPanel"			"16 16 16 255" // Main Menu panel color
		"G_MainMenuButton"			"0 0 0 26" // Main Menu button color
		"G_MainMenuButtonHover"		"0 0 0 26" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"255 255 255 255" // Main Menu button text color
		"G_MainMenuButtonHoverFg"	"87 193 245 255" // Main Menu hovered button text color
		"G_MainMenuShader" 			"0 0 0 0" // Main Menu shader color
		"G_BackpackItemBg"			"66 129 192 255" // Backpack item bg color
		"G_LoadoutItemBg"			"16 26 38 255" // Loadout item bg color
		"G_MenuBg"					"27 40 56 255" // Menu bg color
		"G_MenuText"				"183 198 210 255" // Menu text color
		"G_InputText"				"63 84 101 255" // Input text color
		"G_DimmInputText"			"63 84 101 100" // Dimm Input text color
		"G_DimmMenuText"			"183 198 210 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"38 38 38 255" // Item description panel bg
		"G_ButtonBg"				"75 75 75 255" // Button bg color
		"G_ButtonText"				"226 226 226 255" // Button text color
		"G_ButtonHoverBg"			"85 85 85 255" // Button hover bg color
		"G_ButtonHoverText"			"226 226 226 255" // Button hover text color
		"G_ButtonSelectedBg"		"60 80 110 255" // Button selected bg color
		"G_ButtonSelectedText"		"226 226 226 255" // Button selected text color
		...
		"G_ItemMeterBorder"			"0 0 0 89" // Item meter border color
		"G_MenuShader"				"32 61 90 255" // Menu shader color
		"G_XPBar"					"164 208 7 255" // XP Bar color
		...
		"TFOrange"			"21 69 106 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"21 69 106 255" // Highlight color
		Slider.TextColor			"183 198 210 255" // Menu text color
		Slider.TrackColor			"183 198 210 255" // Menu text color
		Slider.DisabledTextColor1	"183 198 210 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"183 198 210 120" // Dimm Menu text color
